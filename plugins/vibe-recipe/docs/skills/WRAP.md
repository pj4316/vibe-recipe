...
- version source와 changelog source가 명확합니다.
...
여러 manifest version이 있으면 public release artifact에 해당하는 manifest만 갱신합니다. source가 불명확하면 쓰기 전에 멈춥니다.
...
- blocked reason 또는 recommended next skill: `serve`
