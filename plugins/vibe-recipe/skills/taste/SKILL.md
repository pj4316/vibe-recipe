...
`taste`는 review report를 현재 spec 번호에 맞는 `.agent/spec/handoffs/NNNN-taste.md`에 남깁니다. 이 파일은 `peek`, `wrap`, `serve`가 같은 spec의 최신 verdict와 release readiness를 재사용할 수 있는 source입니다.
