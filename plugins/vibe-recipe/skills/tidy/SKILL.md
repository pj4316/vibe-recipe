...
- 리팩터링은 겉으로 보이는 변화가 적으므로, 무엇을 왜 정리하는지 사용자 관점에서 먼저 설명합니다.
- “동작은 그대로 두고 구조만 정리한다”는 점을 반복해서 분명히 해 사용자가 불안하지 않게 안내합니다.
- 구조적 이점은 추상적인 미학보다 유지보수, 이해도, 위험 감소 같은 실질적인 효과로 설명합니다.
- 지금 바로 필요한 정리와 나중에 해도 되는 정리를 구분해 과도한 범위 확장을 막습니다.
