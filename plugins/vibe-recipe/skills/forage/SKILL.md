---
name: forage
description: /vr:forage 호출 시 사용합니다. 계획 전에 옵션을 조사하고 구현 없이 proposed ADR을 작성합니다.
---
...
- 조사 결과는 “무엇이 다른지”, “왜 중요한지”, “그래서 무엇을 추천하는지” 순서로 쉽게 설명합니다.
- 비교 항목은 가능한 한 사용자 관점의 trade-off로 풀어 쓰고, 기술 세부사항은 필요한 만큼만 덧붙입니다.
- 확실한 사실과 아직 확인이 필요한 내용을 분리해서 말해 과장 없이 안내합니다.
- 추천안을 낼 때는 한 줄 결론과 함께 선택 기준을 짧게 설명합니다.

## 시작 조건

- 사용자가 `/vr:forage`, 기술 조사, vendor 비교, library 선택, API 선택, architecture 선택을 요청했습니다.
